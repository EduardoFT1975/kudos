...
// ─── Constantes recuperadas tras truncado (P32 hotfix) ────────────────────
const TENSION_BLOCK: React.CSSProperties = { background: "rgba(20,15,40,0.55)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: 16, marginTop: 8 };
const TENSION_HEAD: React.CSSProperties = { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 };
const TENSION_EYEBROW: React.CSSProperties = { fontSize: 11, color: "rgba(242,242,247,0.6)", letterSpacing: 1 };
const TENSION_TITLE: React.CSSProperties = { fontSize: 15, fontWeight: 700, color: "#fff", margin: "2px 0 0" };
const TENSION_NUMBER: React.CSSProperties = { fontSize: 24, fontWeight: 800, color: "var(--kudos-accent-orange, #FF9A00)", lineHeight: 1 };
const TENSION_NEXT_LEVEL: React.CSSProperties = { fontSize: 11, color: "rgba(242,242,247,0.6)", marginTop: 2 };
const TENSION_CTA: React.CSSProperties = { appearance: "none", border: "none", marginTop: 10, background: "linear-gradient(90deg, #6C3CFF, #FF3CAC)", color: "#fff", padding: "10px 14px", borderRadius: 12, fontWeight: 700, fontSize: 13, cursor: "pointer", width: "100%" };
const PILLARS_GRID: React.CSSProperties = { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 12, marginTop: 12 };
const PILLAR_CARD: React.CSSProperties = { background: "rgba(20,15,40,0.55)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 14, padding: 14 };
const PILLAR_ICON: React.CSSProperties = { fontSize: 18, color: "var(--kudos-accent, #6C3CFF)" };
const PILLAR_LABEL: React.CSSProperties = { fontSize: 12, fontWeight: 700, color: "#fff", marginTop: 6 };
const PILLAR_NUMBER: React.CSSProperties = { fontSize: 20, fontWeight: 800, color: "#fff", lineHeight: 1.1 };
const PILLAR_CAP: React.CSSProperties = { fontSize: 10.5, color: "rgba(242,242,247,0.55)" };
const PILLAR_DESC: React.CSSProperties = { fontSize: 11, color: "rgba(242,242,247,0.72)", marginTop: 6, lineHeight: 1.4 };
const PROGRESS_TRACK: React.CSSProperties = { height: 6, borderRadius: 999, background: "rgba(255,255,255,0.08)", marginTop: 8, overflow: "hidden" };
const PROGRESS_FILL: React.CSSProperties = { height: "100%", background: "linear-gradient(90deg, #6C3CFF, #FF3CAC)" };
const SPLIT: React.CSSProperties = { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 12 };
const PANEL: React.CSSProperties = { background: "rgba(20,15,40,0.55)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 14, padding: 14 };
const PANEL_HEAD: React.CSSProperties = { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 };
const PANEL_TITLE: React.CSSProperties = { fontSize: 13, fontWeight: 700, color: "#fff", margin: 0 };
const POINTS_PILL: React.CSSProperties = { padding: "3px 10px", borderRadius: 999, background: "rgba(108,60,255,0.25)", color: "#fff", fontSize: 11, fontWeight: 700 };
const SEE_ALL: React.CSSProperties = { appearance: "none", background: "transparent", border: "none", color: "var(--kudos-accent, #6C3CFF)", fontSize: 11, fontWeight: 700, cursor: "pointer" };
const LIST: React.CSSProperties = { display: "flex", flexDirection: "column", gap: 8 };
const LOGRO_ROW: React.CSSProperties = { display: "flex", alignItems: "center", gap: 10, padding: 8, borderRadius: 10, background: "rgba(255,255,255,0.03)" };
const LOGRO_ICON: React.CSSProperties = { fontSize: 16, width: 22, textAlign: "center" };
const LOGRO_TITLE: React.CSSProperties = { fontSize: 12, fontWeight: 600, color: "#fff" };
const LOGRO_DESC: React.CSSProperties = { fontSize: 10.5, color: "rgba(242,242,247,0.6)" };
const LOGRO_BADGE_OK: React.CSSProperties = { padding: "2px 8px", borderRadius: 999, background: "rgba(16,185,129,0.18)", color: "#10B981", fontSize: 10, fontWeight: 700 };
const LOGRO_BADGE_PEND: React.CSSProperties = { padding: "2px 8px", borderRadius: 999, background: "rgba(245,158,11,0.18)", color: "#F59E0B", fontSize: 10, fontWeight: 700 };
const NEXT_LOGRO: React.CSSProperties = { fontSize: 11.5, color: "rgba(242,242,247,0.78)", marginTop: 6 };
const NEXT_LOGRO_LINK: React.CSSProperties = { color: "var(--kudos-accent, #6C3CFF)", fontWeight: 700 };
const RECENT_ROW: React.CSSProperties = { display: "flex", alignItems: "center", gap: 10, padding: 8, borderRadius: 10, background: "rgba(255,255,255,0.03)" };
const RECENT_ICON: React.CSSProperties = { fontSize: 14, width: 22, textAlign: "center" };
const RECENT_TITLE: React.CSSProperties = { fontSize: 12, fontWeight: 600, color: "#fff" };
const RECENT_META: React.CSSProperties = { fontSize: 10.5, color: "rgba(242,242,247,0.55)" };
const MULT_GRID: React.CSSProperties = { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: 10 };
const MULT_CARD: React.CSSProperties = { background: "rgba(255,255,255,0.04)", borderRadius: 10, padding: 10 };
const MULT_GLYPH: React.CSSProperties = { fontSize: 18, color: "var(--kudos-accent-orange, #FF9A00)" };
const MULT_VALUE: React.CSSProperties = { fontSize: 18, fontWeight: 800, color: "#fff" };
const MULT_LABEL: React.CSSProperties = { fontSize: 11, color: "rgba(242,242,247,0.78)", fontWeight: 600 };
const MULT_SUB: React.CSSProperties = { fontSize: 10, color: "rgba(242,242,247,0.55)" };
const MULT_LINK: React.CSSProperties = { color: "var(--kudos-accent, #6C3CFF)", fontSize: 11, fontWeight: 700, marginTop: 8, display: "inline-block" };
const MULT_FOOTER: React.CSSProperties = { display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 10, fontSize: 11 };
const MULT_TOTAL_LABEL: React.CSSProperties = { color: "rgba(242,242,247,0.7)" };
const MULT_TOTAL_VALUE: React.CSSProperties = { color: "#fff", fontWeight: 800 };
const BENEFIT_ITEM: React.CSSProperties = { display: "flex", alignItems: "center", gap: 8, padding: "6px 0" };
const BENEFIT_ICON: React.CSSProperties = { fontSize: 14, color: "var(--kudos-accent, #6C3CFF)" };
const BENEFIT_LABEL: React.CSSProperties = { fontSize: 12, fontWeight: 600, color: "#fff" };
const BENEFIT_SUB: React.CSSProperties = { fontSize: 10.5, color: "rgba(242,242,247,0.6)" };
const CHART_WRAP: React.CSSProperties = { display: "flex", alignItems: "flex-end", gap: 4, height: 100, marginTop: 8 };
const CHART_FOOTER: React.CSSProperties = { display: "flex", justifyContent: "space-between", fontSize: 10, color: "rgba(242,242,247,0.55)", marginTop: 6 };
const EMPTY_HINT: React.CSSProperties = { padding: 14, textAlign: "center", color: "rgba(242,242,247,0.55)", fontSize: 12 };
const EMPTY_HINT_GLYPH: React.CSSProperties = { fontSize: 20, marginBottom: 4 };
const EMPTY_HINT_TEXT: React.CSSProperties = {};
const FOOTER_STAT: React.CSSProperties = { display: "flex", alignItems: "center", gap: 6, fontSize: 11 };
const FOOTER_STAT_LABEL: React.CSSProperties = { color: "rgba(242,242,247,0.6)" };
const FOOTER_STAT_VALUE: React.CSSProperties = { color: "#fff", fontWeight: 700 };
const INFO_BAR: React.CSSProperties = { display: "grid", gridTemplateColumns: "auto 1fr auto", alignItems: "center", gap: 12, padding: 12, background: "rgba(108,60,255,0.10)", border: "1px solid rgba(108,60,255,0.25)", borderRadius: 12, marginTop: 8 };
const INFO_BAR_LEFT: React.CSSProperties = {};
const INFO_BAR_RIGHT: React.CSSProperties = { display: "grid", gridAutoFlow: "column", gap: 10, alignItems: "center" };
const INFO_BAR_TITLE: React.CSSProperties = { fontSize: 12, fontWeight: 700, color: "#fff" };
const INFO_BAR_TEXT: React.CSSProperties = { fontSize: 11, color: "rgba(242,242,247,0.78)" };
const INFO_GLYPH: React.CSSProperties = { fontSize: 18, color: "var(--kudos-accent, #6C3CFF)" };
