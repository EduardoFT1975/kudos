...
export function MeritScreen() {
  ...
  return (
    <div className="kudos-merito" style={ROOT}>
      ...
      {/* ── Bottom info bar ─────────────────────────────────────── */}
      <section style={INFO_BAR} className="kudos-elev-1">
...
// Pillars
const PILLARS_GRID: React.CSSProperties = {
  display: "grid",
  gridTemplateColumns: "repeat(5, minmax(0, 1fr))",
  gap: 10,
};

const PILLAR_CARD: React.CSSProperties = {
  display: "flex",
...
const PILLAR_ICON: React.CSSProperties = {
  width: 42, height: 42,
  borderRadius: 12,
  display: "inline-flex",
  alignItems: "center",
...
const PILLAR_NUMBER: React.CSSProperties = {
  display: "inline-flex",
  alignItems: "baseline",
  gap: 3,
  fontFamily: "var(--kudos-font-display)",
...
const PILLAR_CAP: React.CSSProperties = {
  fontFamily: "var(--kudos-font-body)",
  fontSize: 11.5,
  fontWeight: 500,
  color: "rgba(242,242,247,0.45)",
...
const PILLAR_DESC: React.CSSProperties = {
  margin: 0,
  fontSize: 11,
  color: "rgba(242,242,247,0.55)",
  lineHeight: 1.4,
...
const RECENT_ICON: React.CSSProperties = {
  width: 36, height: 36,
  borderRadius: 10,
  display: "inline-flex",
  alignItems: "center",
...
const RECENT_META: React.CSSProperties = {
  fontSize: 11,
  color: "rgba(242,242,247,0.55)",
};

const POINTS_PILL: React.CSSProperties = {
  fontFamily: "var(--kudos-font-display)",
  fontSize: 15,
  fontWeight: 700,
  flexShrink: 0,
...
const LOGRO_ROW: React.CSSProperties = {
  display: "flex",
  alignItems: "center",
  gap: 12,
  padding: "10px 10px",
...
const LOGRO_ICON: React.CSSProperties = {
  width: 40, height: 40,
  borderRadius: 12,
  display: "inline-flex",
  alignItems: "center",
...
const LOGRO_TITLE: React.CSSProperties = {
  fontSize: 13,
  fontWeight: 600,
};

const LOGRO_DESC: React.CSSProperties = {
  fontSize: 11,
  color: "rgba(242,242,247,0.55)",
};

const LOGRO_BADGE_OK: React.CSSProperties = {
  width: 24, height: 24,
  borderRadius: "50%",
  background: "#34D399",
  color: "#0A0612",
...
const LOGRO_BADGE_PEND: React.CSSProperties = {
  width: 24, height: 24,
  borderRadius: "50%",
...
const NEXT_LOGRO: React.CSSProperties = {
  display: "flex",
  justifyContent: "center",
  marginTop: 10,
  paddingTop: 12,
...
const NEXT_LOGRO_LINK: React.CSSProperties = {
  display: "inline-flex",
  alignItems: "center",
  gap: 4,
  color: "var(--kudos-accent-bright, #8B6BFF)",
...
// Multipliers
const MULT_GRID: React.CSSProperties = {
  display: "grid",
  gridTemplateColumns: "repeat(4, minmax(0, 1fr))",
  gap: 10,
};

const MULT_CARD: React.CSSProperties = {
  display: "flex",
  flexDirection: "column",
  alignItems: "flex-start",
  gap: 6,
...
const MULT_LABEL: React.CSSProperties = {
  fontSize: 11.5,
  fontWeight: 600,
  color: "var(--kudos-ink)",
};

const MULT_SUB: React.CSSProperties = {
  fontSize: 10.5,
  color: "rgba(242,242,247,0.55)",
};

const MULT_GLYPH: React.CSSProperties = {
  width: 32, height: 32,
  borderRadius: 10,
  display: "inline-flex",
  alignItems: "center",
...
const MULT_VALUE: React.CSSProperties = {
  fontFamily: "var(--kudos-font-display)",
  fontSize: 22,
  fontWeight: 700,
  letterSpacing: "-0.01em",
...
const MULT_FOOTER: React.CSSProperties = {
  display: "flex",
  alignItems: "center",
  justifyContent: "space-between",
  marginTop: 14,
...
const MULT_TOTAL_LABEL: React.CSSProperties = {
  fontSize: 11,
  color: "rgba(242,242,247,0.55)",
};

const MULT_TOTAL_VALUE: React.CSSProperties = {
  fontFamily: "var(--kudos-font-display)",
  fontSize: 28,
  fontWeight: 700,
  letterSpacing: "-0.01em",
...
const MULT_LINK: React.CSSProperties = {
  display: "inline-flex",
  alignItems: "center",
  gap: 4,
  color: "var(--kudos-accent-bright, #8B6BFF)",
...
const CHART_FOOTER: React.CSSProperties = {
  display: "grid",
...
const FOOTER_STAT: React.CSSProperties = {
  display: "flex",
  flexDirection: "column",
  alignItems: "center",
  gap: 4,
...
const FOOTER_STAT_LABEL: React.CSSProperties = {
  fontSize: 9.5,
  fontWeight: 700,
...
const FOOTER_STAT_VALUE: React.CSSProperties = {
  fontFamily: "var(--kudos-font-display)",
  fontSize: 22,
  fontWeight: 700,
  letterSpacing: "-0.01em",
...
// Info bar
const INFO_BAR: React.CSSProperties = {
  display: "grid",
  gridTemplateColumns: "minmax(0, 1.4fr) minmax(0, 1fr)",
  gap: 18,
  padding: 18,
  borderRadius: 16,
  background: "linear-gradient(135deg, rgba(108,60,255,0.12) 0%, rgba(255,60,172,0.04) 100%)",
...
const INFO_GLYPH: React.CSSProperties = {
  width: 30, height: 30,
  borderRadius: 10,
  background: "rgba(108,60,255,0.18)",
  color: "var(--kudos-accent-bright, #8B6BFF)",
...
const INFO_BAR_TITLE: React.CSSProperties = {
  margin: 0,
  fontSize: 13.5,
  fontWeight: 700,
  color: "var(--kudos-accent-bright, #8B6BFF)",
...
const INFO_BAR_TEXT: React.CSSProperties = {
  margin: 0,
  fontSize: 12,
...
const INFO_BAR_RIGHT: React.CSSProperties = {
  display: "grid",
  gridTemplateColumns: "repeat(3, minmax(0, 1fr))",
  gap: 10,
};

const BENEFIT_ITEM: React.CSSProperties = {
  display: "flex",
  alignItems: "center",
  gap: 8,
};

const BENEFIT_ICON: React.CSSProperties = {
  width: 28, height: 28,
  borderRadius: 8,
  background: "rgba(255,255,255,0.05)",
...
const BENEFIT_LABEL: React.CSSProperties = {
  fontSize: 11.5,
  fontWeight: 600,
  color: "var(--kudos-ink)",
};

const BENEFIT_SUB: React.CSSProperties = {
  fontSize: 10.5,
  color: "rgba(242,242,247,0.55)",
};
...
const EMPTY_HINT_GLYPH: React.CSSProperties = {
  width: 30, height: 30,
  borderRadius: 10,
...
// ── Tension block (Prompt 11/12) ─────────────────────────────────

const TENSION_BLOCK: React.CSSProperties = {
  display: "flex",
  flexDirection: "column",
  gap: 12,
  padding: "18px 20px",
...
const TENSION_HEAD: React.CSSProperties = {
  display: "flex",
  alignItems: "flex-start",
  justifyContent: "space-between",
  gap: 14,
...
const TENSION_EYEBROW: React.CSSProperties = {
  fontSize: 10.5,
  fontWeight: 700,
...
const TENSION_TITLE: React.CSSProperties = {
  margin: 0,
  fontFamily: "var(--kudos-font-display)",
...
const TENSION_NUMBER: React.CSSProperties = {
  fontWeight: 700,
  color: "var(--kudos-accent-orange, #FF9A00)",
};

const TENSION_NEXT_LEVEL: React.CSSProperties = {
  fontWeight: 700,
  color: "var(--kudos-accent-bright, #8B6BFF)",
};

const TENSION_CTA: React.CSSProperties = {
  display: "inline-flex",
  alignItems: "center",
  gap: 6,
  padding: "10px 18px",
