...
# Paso 1: Obtener datos de Wikipedia (ejemplo: Pirámides de Giza)
...
def create_capsule_csv():
    queries = ["Pyramids of Giza", "Eiffel Tower"]  # Ejemplo de temas
    capsules = []
    ...
    for query in queries:
        ...
        if lat and lon:
            capsule = {
                "content": content[:500],  # Limitar texto
                "latitude": lat,
                "longitude": lon,
                "date": "2023-10-01",  # Fecha fija para ejemplo
                "theme": query
            }
...
def import_to_kudos():
    if os.path.exists(CSV_OUTPUT):
        ...
        # Aquí iría la llamada real a import_data.py
    else:
